...
AWS_S3_BUCKET := blog.hirschauer-it.de
...
purge-cache:
	docker run --rm -it  -e AWS_ACCESS_KEY -e AWS_SECRET_KEY -e AWS_CF_DISTRIBUTION_ID -e AWS_S3_BUCKET=blog.hirschauer-it.de $(REGISTRY)/cf-reset-cache
